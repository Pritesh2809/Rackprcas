      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\team-member-haripriya .jpg"
            ...
            {/* Rtr. Mounesh – Secretary – Communication */}
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src/assets/mounish.jpg"
                        alt="Rtr. Mounesh – Secretary – Communication"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      where his keen knowledge in managing finances ensured transparency and efficiency in the club’s operations.
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            of the event—providing both operational support and unwavering morale strength to the team.
                          </p>
                        </div>
                        ...
                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Current Role</h5>
                          <p className="text-gray-700 text-sm">
                            Recognizing his contributions and commitment, Rtr. Mounesh now serves as the Secretary – Communication
                            for the Vision Year. With his experience, steadfast nature, and passion for service, he continues to
                            strengthen the spirit of teamwork, ensure effective communication, and add immense value to the club’s endeavors.
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">💰</span>
                        <span className="text-xs text-gray-700">Financial Transparency as Treasurer</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">Active Participation in District Events</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🏛️</span>
                        <span className="text-xs text-gray-700">Pillar of Support in IDYE</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🛡️</span>
                        <span className="text-xs text-gray-700">Reliable & Resilient Leader</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">📢</span>
                        <span className="text-xs text-gray-700">Secretary – Communication (Vision Year)</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-midun.jpg"
                        alt="Rtr. Midun – Treasurer"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      With a strong interest in sports, Midun enjoys playing cricket, which teaches him discipline, strategy, and collaboration—values
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🏏</span>
                        <span className="text-xs text-gray-700">Cricket Enthusiast & Team Player</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🧘</span>
                        <span className="text-xs text-gray-700">Calm & Focused Under Pressure</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">💼</span>
                        <span className="text-xs text-gray-700">Financial Accuracy & Transparency</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">📊</span>
                        <span className="text-xs text-gray-700">Organizational & Leadership Skills</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Vision of Family Leadership & Growth</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Rtr. Prabhagar S – Community Service Director */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  {/* Team Member Photo */}
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-prabhagar.jpg"
                        alt="Rtr. Prabhagar S – Community Service Director"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                    ...
                    {showCommunityDetails && (
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            Being an active member, he stays involved in every stage of projects—from planning to execution—ensuring
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            others to join the journey of service. He is bold in his approach—never afraid to step out of his comfort
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Passionate Community Service Leader</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">⚡</span>
                        <span className="text-xs text-gray-700">Bold & Confident Decision Maker</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">📋</span>
                        <span className="text-xs text-gray-700">Hands-On in Planning & Execution</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">Impactful Outreach & Partnerships</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Inspires & Empowers Communities</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Rtr. Mirthula R – International Service Director */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  {/* Team Member Photo */}
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\team-member-mirthural.jpg"
                        alt="Rtr. Mirthula R – International Service Director"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🌐</span>
                        <span className="text-xs text-gray-700">International Service Advocate</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">📚</span>
                        <span className="text-xs text-gray-700">Balances Learning & Practical Experience</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Team-Oriented & Independent Worker</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">💡</span>
                        <span className="text-xs text-gray-700">Creative Thinker & Problem Solver</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Motivated & Positive Contributor</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Rtr. Indupriya S – Community Service Chair */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  {/* Team Member Photo */}
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-indupriya.jpg"
                        alt="Rtr. Indupriya S – Community Service Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      even the smallest effort can bring a smile to someone’s face, and that is what motivates her every day.
                    </p>
                      ...
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            across different projects. Whether it’s planning, organizing, or hands-on execution, she gives
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            ...
                            in people’s lives—uplifting communities with compassion, action, and dedication.
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🌱</span>
                        <span className="text-xs text-gray-700">Dedicated to Community Impact</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Strong Team Player & Communicator</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🧘</span>
                        <span className="text-xs text-gray-700">Handles Challenges Calmly & Practically</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">💪</span>
                        <span className="text-xs text-gray-700">Hardworking & Responsible Leader</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Passionate About Service Projects</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Rtr. Monisha – Chair, District Priority Projects */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-monisha.jpg"
                        alt="Rtr. Monisha – Chair, District Priority Projects"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      I am Rtr. Monisha, currently serving as the Chair – District Priority Projects of the Rotaract Club of KPRCAS.
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            who share the vision of “Service Above Self.”
                          </p>
                        </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Chair – District Priority Projects</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Leadership, Service & Personal Growth</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🧶</span>
                        <span className="text-xs text-gray-700">Creative Thinker (Crocheting)</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Impact-Oriented Vision</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
            ...
            {/* Rtr. Rithanya L – Director, Professional Services */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\rithanaya.jpg"
                        alt="Rtr. Rithanya L – Director, Professional Services"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      I am Rtr. Rithanya L, proudly serving as the Director – Professional Services of the Rotaract Club of KPRCAS.
                      ...
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            just a platform—it is a movement that empowers me to transform ideas into action.
                          </p>
                        </div>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            the vision of “Service with Impact.”
                          </p>
                        </div>
                        ...
                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Creativity & Craft</h5>
                          <p className="text-gray-700 text-sm mb-3">
                            Beyond my academic and Rotaract commitments, I find joy in crocheting—a creative pursuit that
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Director – Professional Services</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Leadership, Service & Personal Growth</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Transforms Ideas into Action</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Embodies “Service with Impact”</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Anuvarshini K.M – Director of Reporting and Grievance */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-anuvarshini.jpg"
                        alt="Rtr. Anuvarshini K.M – Director of Reporting and Grievance"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                      ...
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            and suggestions. As Director of Reporting and Grievance, I aim to ensure that every member’s voice is heard,
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Director – Reporting and Grievance</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Transparency & Communication</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Problem-Solver with Positive Mindset</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Unity & Member Participation</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">💡</span>
                        <span className="text-xs text-gray-700">Dedicated to Service & Growth</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Sivaharini K. – Chair, Grievances and Reporting */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\sivaharini.jpg"
                        alt="Rtr. Sivaharini K – Chair, Grievances and Reporting"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                    ...
                    {showSivahariniDetails && (
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            During my tenure as Secretary (2024–2025), I acted as a vital link between faculty and students, effectively
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            <strong> Grievances & Reporting Chair</strong>, I’m recognized for my approachable nature, active listening,
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Chair – Grievances and Reporting</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Leadership, Communication & Teamwork</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🎤</span>
                        <span className="text-xs text-gray-700">Event Host & Public Speaker</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Organizer of MAVERICKS'25</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Conflict Resolution & Transparency</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Srinithi – Club Service Chair */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\Srinith.jpg"
                        alt="Rtr. Srinithi – Club Service Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                    ...
                    {showSrinithiDetails && (
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            I believe club service is more than just managing activities—it is about creating meaningful
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            I also had the opportunity to emcee key programs such as <strong>Farewell ’24</strong> and
                            <strong> Charter’s Day ’25</strong>, showcasing my confidence in public speaking and ability
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Club Service Chair</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Leadership & Team Collaboration</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🎤</span>
                        <span className="text-xs text-gray-700">Event Host – Farewell ’24 & Charter’s Day ’25</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Organizer of Club Service Events</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Department President Experience</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Priyanka J. K – Chair, All Operations */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\JK priyanka .jpg"
                        alt="Rtr. Priyanka J. K – Chair, All Operations"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      For the year 2024–2025, I held the position of Secretary of Communication,
                      ...
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            all levels of the club’s functioning.
                          </p>
                        </div>

                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Chair – All Operations</h5>
                          <p className="text-gray-700 text-sm mb-3">
                            Building on this foundation, I have taken up the role of Chair – All Operations
                            for the year 2025–2026. This role carries greater responsibility, involving
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🏅</span>
                        <span className="text-xs text-gray-700">Chair – All Operations (2025–2026)</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">📩</span>
                        <span className="text-xs text-gray-700">Former Secretary of Communication (2024–2025)</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Teamwork & Coordination</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Efficient Planning & Execution</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Leadership & Professional Growth</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Naren – International Service Director */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-naren.jpg"
                        alt="Rtr. Naren – International Service Director"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      discipline, strategy, and collaboration—values that continue to shape
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            embodying the true essence of Rotaract’s international service.
                          </p>
                        </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">International Service Director</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🏏</span>
                        <span className="text-xs text-gray-700">Cricket Enthusiast – Discipline & Strategy</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🧘</span>
                        <span className="text-xs text-gray-700">Calm & Focused Under Pressure</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Cross-Cultural Connections & Inclusivity</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-orange-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Leadership & Family Values</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Mirthula – International Service Chair */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-mirthula.jpg"
                        alt="Rtr. Mirthula – International Service Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      Meet the dynamic teenage girl who's bursting with youthful energy!
                      I am passionate about traveling, exploring new places, and soaking
                      up different cultures while making unforgettable memories.
                    </p>

                    {showMirthulaDetails && (
                      <>
                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Young & Energetic</h5>
                          <p className="text-gray-700 text-sm mb-3">
                            Full of life and enthusiasm, I am always up for new adventures
                            and eager to broaden my horizons by meeting new people and
                            discovering different cultures.
                          </p>
                        </div>

                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Leadership Skills</h5>
                          <p className="text-gray-700 text-sm mb-3">
                            With a natural flair for leadership, I am confident in guiding
                            others and making impactful decisions. I enjoy working with teams
                            and inspiring collaboration.
                          </p>
                        </div>

                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">International Service Role</h5>
                          <p className="text-gray-700 text-sm">
                            As the International Service Chair in Rotaract, I am taking on
                            a significant role in promoting global understanding,
                            cross-cultural engagement, and community service initiatives.
                            My passion for travel and leadership drives me to make a positive
                    ...
                    <div className="text-center mt-4">
                      <Button
                        onClick={() => setShowMirthulaDetails(!showMirthulaDetails)}
                        variant="outline"
                        size="sm"
                        className="text-primary border-primary hover:bg-primary hover:text-white transition-colors"
                      >
                        {showMirthulaDetails ? 'Read Less' : 'Read More'}
                      </Button>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">International Service Chair</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✈️</span>
                        <span className="text-xs text-gray-700">Loves Traveling & Exploring Cultures</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">⚡</span>
                        <span className="text-xs text-gray-700">Youthful Energy & Enthusiasm</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">👩‍💼</span>
                        <span className="text-xs text-gray-700">Natural Leadership Skills</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Global Service & Community Engagement</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Prajjeeith – District Priority Projects Director */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="/src/assets/team-member-prajjeeith.jpg"
                        alt="Rtr. Prajjeeith – District Priority Projects Director"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            ...
                            contributions that align with Rotaract’s values.
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">📌</span>
                        <span className="text-xs text-gray-700">District Priority Projects Director</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">💡</span>
                        <span className="text-xs text-gray-700">Strong Leadership & Team Support</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🛠️</span>
                        <span className="text-xs text-gray-700">Event Management & Project Execution</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Team Collaboration & Coordination</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-red-600 text-xs">🚀</span>
                        <span className="text-xs text-gray-700">Vision for Innovation & Sustainability</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Deepana – Chair of Professional Services */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\deepana.jpg"
                        alt="Rtr. Deepana – Chair of Professional Services"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      individuals united by the vision of “Service with Impact.”
                    </p>
                    ...
                    {showDeepanaDetails && (
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            Through this journey, I’ve developed leadership skills,
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            for personal growth and creativity. Whether it’s acquiring
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            My goal is to embody the spirit of Rotaract – learning,
                            leading, and serving with purpose – while inspiring
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">📌</span>
                        <span className="text-xs text-gray-700">Chair of Professional Services</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🌱</span>
                        <span className="text-xs text-gray-700">Leadership & Continuous Growth</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Collaboration & Team Spirit</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Service with Purpose & Impact</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Personal Growth & Creativity</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Miruthula Sri – International Service Chair */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\mirthal sri .jpg"
                        alt="Rtr. Miruthula Sri – International Service Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      <span className="font-semibold"> International Service Chair</span>, she’s
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Young, Energetic & Passionate</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">✈️</span>
                        <span className="text-xs text-gray-700">Loves Traveling & Exploring Cultures</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Committed to Global Service & Fellowship</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\Dharanessh.jpg"
                        alt="Rtr. Dharaneesh – Treasurer"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">💰</span>
                        <span className="text-xs text-gray-700">Treasurer – Financial Oversight</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">📅</span>
                        <span className="text-xs text-gray-700">Organizer of Events & Campaigns</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Collaboration & Partnerships</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">👨‍💼</span>
                        <span className="text-xs text-gray-700">Leadership & Decision-Making</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Service Above Self</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Brindha – Director, Professional Services */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\Brinda.jpg"
                        alt="Rtr. Brindha – Director, Professional Services"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      <span className="font-semibold"> Director – Professional Services</span>
                      ...
                      <>
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            as more than just a platform—it is a movement that empowers me
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            “Service Beyond Self, Impact Beyond Measure.”
                          </p>
                        </div>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            Beyond academics and Rotaract, I find joy in crocheting—a hobby
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">📖</span>
                        <span className="text-xs text-gray-700">Balancing Academics & Service</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">Service Beyond Self, Impact Beyond Measure</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🧶</span>
                        <span className="text-xs text-gray-700">Creative Hobby – Crocheting</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Leadership, Growth & Inspiration</span>
                      </div>
                    </div>
                  </div>
            ...
            {/* Rtr. Pavithra KS – Chair, Interact–Rotaract Relationship */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\Pavithra.jpg"
                        alt="Rtr. Pavithra KS – Chair, Interact–Rotaract Relationship"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      <span className="font-semibold"> Chair – Interact–Rotaract Relationship</span>
                      of the Rotaract Club of KPRCAS. At KPRCAS, I strive to balance academics
                    ...
                    {showPavithraDetails && (
                      <>
                        ...
                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Creative Pursuits</h5>
                          <p className="text-gray-700 text-sm">
                            Beyond academics and Rotaract, I find joy in crocheting—a creative
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            ...
                            integrity, and serve wholeheartedly—leaving behind footprints of
                            positive change.
                          </p>
                          <p className="italic text-primary text-sm mt-2">
                            ✨ “True leadership lies in learning, serving, and inspiring others to
                            believe that change begins with them.”
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">📌</span>
                        <span className="text-xs text-gray-700">Chair – Interact–Rotaract Relationship</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">📖</span>
                        <span className="text-xs text-gray-700">Balancing Academics & Service</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">Transforming Ideas into Action</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🧶</span>
                        <span className="text-xs text-gray-700">Creative Hobby – Crocheting</span>
            ...
            {/* Rtr. Praveen – Club Service Director */}
            <AnimationWrapper delay={500}>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\praveen .jpeg"
                        alt="Rtr. Praveen – Club Service Director"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            ...
                            a life of comfort, respect, and happiness—while growing continuously,
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">📌</span>
                        <span className="text-xs text-gray-700">Club Service Director</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">⚽</span>
                        <span className="text-xs text-gray-700">Sports Enthusiast – Cricket & Football</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌟</span>
                        <span className="text-xs text-gray-700">Calm & Focused Under Pressure</span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Promotes Fellowship & Bonding</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">🎯</span>
                        <span className="text-xs text-gray-700">Vision – Lead with Dignity & Determination</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src\assets\drive-download-20250813T152136Z-1-001\Sanjay.jpg"
                        alt="Rtr. Sanjay D – All Avenue Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                    ...
                    {showSanjayDetails && (
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            My role extends beyond coordination—I inspire creativity, motivate members, and
                        ...
                        <div className="mb-4">
                          <h5 className="font-semibold text-gray-900 mb-2 text-sm">Vision & Mission</h5>
                          <p className="text-gray-700 text-sm">
                            My commitment as All Avenue Chair reflects the true essence of Rotaract leadership—
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">📌</span>
                        <span className="text-xs text-gray-700">All Avenue Chair</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Harmonizes All Avenues of Service</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">🌍</span>
                        <span className="text-xs text-gray-700">Promotes Collaboration & Inclusiveness</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">💡</span>
                        <span className="text-xs text-gray-700">Encourages Innovation & Creativity</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Embodies “Service Above Self”</span>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto transition-transform duration-300 hover:scale-105">
                      <img
                        src="src/assets/drive-download-20250813T152136Z-1-001/rashvandh.jpg"
                        alt="Rtr. [Your Name] – Web Chair"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                      ...
                      technology and creativity to strengthen our club’s digital presence.
                    </p>
                      ...
                      <>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            create impactful online platforms that represent our club’s spirit, projects,
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm mb-3">
                            ...
                            but also with the wider community—fostering collaboration, innovation, and unity.
                          </p>
                        </div>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-gray-700 text-sm">
                            ...
                            our club’s digital identity remains strong, engaging, and inspiring for all.
                          </p>
                          <p className="italic text-primary text-sm mt-2">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-blue-600 text-xs">🌐</span>
                        <span className="text-xs text-gray-700">Web Chair – First Year</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-green-600 text-xs">🚀</span>
                        <span className="text-xs text-gray-700">Fresh Perspective & Eager to Learn</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-purple-600 text-xs">💻</span>
                        <span className="text-xs text-gray-700">Passionate About Technology & Digital Growth</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-yellow-600 text-xs">🤝</span>
                        <span className="text-xs text-gray-700">Connects Members Through Online Platforms</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-pink-600 text-xs">✨</span>
                        <span className="text-xs text-gray-700">Vision – Strengthen Club’s Digital Identity</span>
                      </div>
                    </div>
                  </div>
